...
public class WeatherCrudTest {
    ...
    public void testCreateBulkAndGet() {
        ...
        var retrievedNull = weatherService.get(new WeatherKey(-1, city11));
    ...
    public void testExists() {
        ...
        assertFalse("Made up weather should not exist.", weatherService.exists(new WeatherKey(-1, city11)));
    }
